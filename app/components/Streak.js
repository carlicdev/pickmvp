  ...
  return (
    <div className='max-w-80 text-center mx-auto'>
        <div className='flex px-15 justify-center w-full mx-auto'>
            <div className='bg-orange-700 p-5 rounded-t-lg w-[200px]'>
                <p className='font-black text-slate-100 text-2xl uppercase'>{title}</p>
            </div>
        </div>
        ...
        <div className='flex px-15 justify-center w-full  mx-auto'>
            <div className='bg-orange-700 p-5 rounded-b-lg w-[200px]'>
                <p className='font-black text-slate-100 text-2xl uppercase'>{timelapse}</p>
            </div>
        </div>
    </div>
  )
