        ...
        <div className='bg-slate-900 bg-opacity-70 h-full lg:p-20 p-5'>
            <div className='max-w-7xl w-full h-full mx-auto flex flex-wrap align-center items-center'>
                <div className='w-full flex flex-col justify-center'>
                    <p className='font-black text-5xl lg:text-7xl text-slate-100 capitalize mb-5 text-gray-200'>The <span className='text-orange-600'>Star Player</span> in <br/>sports handicapping.</p>
